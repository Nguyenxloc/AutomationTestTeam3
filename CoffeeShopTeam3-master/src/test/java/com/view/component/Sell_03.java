...
public class Sell_03 extends TestCase {
    ...
    ChiTietDoUong drinkDetail1 = LstChiTietDoUong_singleton.getInstance().lstChiTietDoUongs.get(1);
    ...
    public void testShowDetailHoaDonTab() {
        //TestCase: SEll_03 thêm đồ uống với 2 đồ uống trùng nhau
